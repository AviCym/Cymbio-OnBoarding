...
const order_lines_1 = __importDefault(require("../../db/models/order-lines"));
    ...
    async consumer() {
        await this.channelWrapper.consume(this.queueName, async (message) => {
            try {
                ...
                await orders_1.default.query().insertGraph(messageInJSON);
                await order_lines_1.default.query().insertGraph(messageInJSON.order_lines);
...
//     }
//   }
//# sourceMappingURL=queue.rabbitmq.js.map